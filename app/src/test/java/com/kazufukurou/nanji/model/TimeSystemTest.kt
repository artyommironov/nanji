...
class TimeSystemTest {
  @Test
  fun getTimeTextJa() = with(JapaneseTimeSystem(useEra = false, useWords = false, useTwentyFourHours = false)) {
  ...
  @Test
  fun getTimeTextJaWords() = with(JapaneseTimeSystem(useEra = false, useWords = true, useTwentyFourHours = false)) {
  ...
  @Test
  fun getTimeTextJaTwentyFour() = with(JapaneseTimeSystem(useEra = false, useWords = false, useTwentyFourHours = true)) {
  ...
  @Test
  fun getTimeTextJaWordsTwentyFour() = with(JapaneseTimeSystem(useEra = false, useWords = true, useTwentyFourHours = true)) {
  ...
  @Test
  fun getTimeTextZh() = with(ChineseTimeSystem(simplified = true, useWords = false, useTwentyFourHours = false)) {
  ...
  @Test
  fun getTimeTextZhWords() = with(ChineseTimeSystem(simplified = true, useWords = true, useTwentyFourHours = false)) {
  ...
  @Test
  fun getTimeTextZhTwentyFour() = with(ChineseTimeSystem(simplified = true, useWords = false, useTwentyFourHours = true)) {
  ...
  @Test
  fun getTimeTextZhWordsTwentyFour() = with(ChineseTimeSystem(simplified = true, useWords = true, useTwentyFourHours = true)) {
  ...
  @Test
  fun getTimeTextKo() = with(KoreanTimeSystem(useWords = false, useTwentyFourHours = false)) {
    assertEquals("새벽12시0분", hm(0, 0))
  }

  @Test
  fun getTimeTextKoWords() = with(KoreanTimeSystem(useWords = true, useTwentyFourHours = false)) {
    assertEquals("새벽열두시영분", hm(0, 0))
  }

  @Test
  fun getTimeTextKoTwentyFour() = with(KoreanTimeSystem(useWords = false, useTwentyFourHours = true)) {
    assertEquals("0시0분", hm(0, 0))
  }

  @Test
  fun getTimeTextKoWordsTwentyFour() = with(KoreanTimeSystem(useWords = true, useTwentyFourHours = true)) {
    assertEquals("영시영분", hm(0, 0))
  }

  @Test
  fun getTimeTextRu() = with(RussianTimeSystem(useWords = false, useTwentyFourHours = false)) {
  ...
  @Test
  fun getTimeTextRuWords() = with(RussianTimeSystem(useWords = true, useTwentyFourHours = false)) {
  ...
  @Test
  fun getTimeTextRuTwentyFour() = with(RussianTimeSystem(useWords = false, useTwentyFourHours = true)) {
  ...
  @Test
  fun getTimeTextRuWordsTwentyFour() = with(RussianTimeSystem(useWords = true, useTwentyFourHours = true)) {
  ...
  @Test
  fun getTimeTextEn() = with(EnglishTimeSystem(useWords = false, useTwentyFourHours = false)) {
  ...
  @Test
  fun getTimeTextEnWords() = with(EnglishTimeSystem(useWords = true, useTwentyFourHours = false)) {
  ...
  @Test
  fun getTimeTextEnTwentyFour() = with(EnglishTimeSystem(useWords = false, useTwentyFourHours = true)) {
  ...
  @Test
  fun getTimeTextEnWordsTwentyFour() = with(EnglishTimeSystem(useWords = true, useTwentyFourHours = true)) {
  ...
  @Test
  fun getDateTextEn() = with(EnglishTimeSystem(useWords = false, useTwentyFourHours = false)) {
  ...
  @Test
  fun getDateTextJa() = with(JapaneseTimeSystem(useEra = false, useWords = true, useTwentyFourHours = false)) {
    assertEquals("一九九一年四月十八日木曜日", ymd(1991, Calendar.APRIL, 18))
    assertEquals("二〇一九年十二月三十一日火曜日", ymd(2019, Calendar.DECEMBER, 31))
  }

  @Test
  fun getDateTextJaEra() = with(JapaneseTimeSystem(useEra = true, useWords = true, useTwentyFourHours = false)) {
    assertEquals("令和一年十二月三十一日火曜日", ymd(2019, Calendar.DECEMBER, 31))
    assertEquals("令和四年十二月三十一日土曜日", ymd(2022, Calendar.DECEMBER, 31))
  }

  @Test
  fun getDateTextZh() = with(ChineseTimeSystem(simplified = true, useWords = false, useTwentyFourHours = false)) {
    assertEquals("2019年12月31日星期二", ymd(2019, Calendar.DECEMBER, 31))
  }

  @Test
  fun getDateTextZhWords() = with(ChineseTimeSystem(simplified = true, useWords = true, useTwentyFourHours = false)) {
    assertEquals("二〇一九年十二月三十一日星期二", ymd(2019, Calendar.DECEMBER, 31))
  }

  @Test
  fun getDateTextKo() = with(KoreanTimeSystem(useWords = true, useTwentyFourHours = false)) {
  ...
  private fun TimeSystem.hm(hour: Int, minute: Int): String {
    return getTimeText(
  ...
  private fun TimeSystem.ymd(year: Int, month: Int, day: Int): String {
    return getDateText(
      cal = Calendar.getInstance().apply {
